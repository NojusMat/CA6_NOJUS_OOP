...
public class App {
    ...
    public Player start() throws DaoException {
        ...
        HashSet<Integer> cache;     //hashset used for collecting the player ID
        HashSet<Integer> cacheArena = new HashSet<Integer>(); //hashset used for collecting the player ID
        try {
            cache = new HashSet<>();
